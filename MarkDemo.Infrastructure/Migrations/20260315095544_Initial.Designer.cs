...
namespace MarkDemo.Infrastructure.Migrations
{
    ...
    [Migration("20260315095544_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarkDemo.Domain.Entities.Address", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarkDemo.Domain.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("MarkDemo.Domain.Entities.SalesOrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MarkDemo.Domain.Entities.SalesOrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MarkDemo.Domain.Entities.SalesOrderHeaderTaken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("MarkDemo.Domain.Entities.SalesOrderDetail", b =>
                {
                    b.HasOne("MarkDemo.Domain.Entities.SalesOrderHeader", "SalesOrderHeader")
            ...
            modelBuilder.Entity("MarkDemo.Domain.Entities.SalesOrderHeader", b =>
                {
                    b.HasOne("MarkDemo.Domain.Entities.Address", "BillingAddress")
                        .WithMany()
                        .HasForeignKey("BillToAddressId")
                        .HasConstraintName("FK_SalesOrderHeader_Address_BillTo_AddressID");

                    b.HasOne("MarkDemo.Domain.Entities.Customer", "Customer")
                        .WithMany()
                        .HasForeignKey("CustomerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MarkDemo.Domain.Entities.Address", "ShippingAddress")
                        .WithMany()
